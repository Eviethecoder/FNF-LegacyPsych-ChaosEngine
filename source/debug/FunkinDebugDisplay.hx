...
class FunkinDebugDisplay extends Sprite
{
	...
	public var isAdvanced(default, set):Bool = true;
	...
	function createAdvancedElements():Void
	{
		...
		#if !html5
		gcMemGraph = new FunkinStatsGraph(OTHERS_OFFSET, Math.floor(OTHERS_OFFSET + (fpsGraph.y + fpsGraph.axisHeight) + 22), graphsWidth, graphsHeight,
			0xFF0000);
