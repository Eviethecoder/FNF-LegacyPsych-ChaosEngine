...
class HudHandler extends FlxGroup
{
	...
	public function barsetup()
	{
		...
		else
		{
			...
			{
				healthBar = new Bar(-200, FlxG.height * (!ClientPrefs.data.downScroll ? 0.89 : 0.11), bars.healthbar.barStyle, gethealthbargraphics(1),
			...
			{
				healthBar = new Bar(0, FlxG.height * (!ClientPrefs.data.downScroll ? 0.89 : 0.11), bars.healthbar.barStyle, gethealthbargraphics(0),
					function() return PlayState.instance.health, 0, 2);
