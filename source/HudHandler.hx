...
class HudHandler extends FlxGroup{
    ...
    public function barsetup(){
        ...
        if (bars == null) {
            ...
            if(bars.healthbar.barStyle == 'png'){
                ...
                healthBar = new Bar(-200, FlxG.height * (!ClientPrefs.data.downScroll ? 0.11 : 0.89),bars.healthbar.barStyle, hudData.gethealthbargraphics(1), function() return PlayState.instance.health, 0, 2);
                ...
                healthBar = new Bar(0, FlxG.height * (!ClientPrefs.data.downScroll ? 0.11 : 0.89    ),bars.healthbar.barStyle, hudData.gethealthbargraphics(0), function() return PlayState.instance.health, 0, 2);
	...
	{
		healthBar.setColors(FlxColor.fromRGB(PlayState.instance.stage.dad.healthColorArray[0], PlayState.instance.stage.dad.healthColorArray[1], PlayState.instance.stage.dad.healthColorArray[2]),
			FlxColor.fromRGB(PlayState.instance.stage.boyfriend.healthColorArray[0], PlayState.instance.stage.boyfriend.healthColorArray[1], PlayState.instance.stage.boyfriend.healthColorArray[2]));
